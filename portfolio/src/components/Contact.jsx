  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full px-6">
        ...
        >
          <div className="p-6 bg-gray-100 rounded-lg flex flex-col justify-center h-full">
            ...
            <div className="flex items-center mt-8 text-gray-600 justify-center">
              <svg
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
            ...
            <div className="flex items-center mt-4 text-gray-600 justify-center">
              <svg
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
                ...
                className="w-8 h-8 text-gray-500"
              >
                <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1
              ...
              <div className="ml-4 text-md font-semibold w-60">6377266103</div>
            </div>
          ...
          <div className="p-6 flex flex-col justify-center items-center h-full">
            {/* Add contact form or image if needed */}
             </div>
        </motion.div>
      </div>
    </section>
